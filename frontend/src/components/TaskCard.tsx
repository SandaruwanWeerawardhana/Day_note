...
export function TaskCard({ task, onComplete }: TaskCardProps) {
  return (
    <div className="flex items-center justify-between gap-4 rounded-xl border border-slate-600 bg-slate-700/60 backdrop-blur-md px-4 py-3 shadow-lg shadow-cyan-500/10 hover:border-cyan-500/50 transition-all min-h-[90px] h-[90px]">
